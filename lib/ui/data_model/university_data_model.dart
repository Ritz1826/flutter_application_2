...
//
//     final universityData = universityDataFromJson(jsonString);

import 'dart:convert';

UniversityData universityDataFromJson(String str) =>
    UniversityData.fromJson(json.decode(str));

String universityDataToJson(UniversityData data) => json.encode(data.toJson());
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    role: roleValues.map[json["role"] ?? ""] ?? Role.MODERATOR,
  );
